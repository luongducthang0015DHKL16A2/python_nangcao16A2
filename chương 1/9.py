...
class hinh_binh_hanh(da_giac):
      ...
      def dien_tich(self):
            return self.c_rong[0] * self.c_cao
      
class hinh_chu_nhat(hinh_binh_hanh):
      def __init__(self,c_rong,c_cao):
            super().__init__(c_rong,c_cao,c_cao)
            
      def dien_tich(self):
            return self.c_rong[0]*self.c_rong[1]
